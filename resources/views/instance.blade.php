...
<head>
    ...
    <meta name="description"
          content="We provide personalized service and an engaging immersive virtual experience that will make your customers desire more.    ">
    <meta name="keywords" content="digitales, ar, metaverse, vr, ">
                            ...
                            <div class="rainbow-card portfolio">
                                <div class="inner">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="title mb--10">
                                            <span>Status:</span>
                                            <span id="i-" style="color: gray;">unkown</span>
                                        </h5>
                                    </div>

                                    <div class="text-center" style="padding-bottom: 3rem; ">
                                        <button onclick="powerInstance('start','i-')"
                                                class="btn-default btn-large" style=" font-weight: bold;">
                                                <span style="padding-left: 3rem; padding-right: 3rem;">
                                                    Start
                                                </span>
                                        </button>
                                        <button onclick="powerInstance('stop','	i-')"
                                                class="btn-default btn-large" style="font-weight: bold;">
                                                <span style="padding-left: 3rem; padding-right: 3rem;">
                                                    Stop
                                                </span>
